...
#>
    ...
    begin
    {
        ...
        {
            Write-Error -Message "This function needs administrator rights." -Category PermissionDenied -ErrorAction Stop
        }
...
#>
    ...
    process
    {
        if (!$ConnectionNames)
        {
            ...
            $output.GetEnumerator() | Select-Object @{Name='NetworkConnectionName';Expression={$_.Key}}, @{Name='StatusICS';Expression={$_.Value}}
        }
        else
        {
            $output = @{}
